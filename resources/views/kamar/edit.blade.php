    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <p class="h3 text-center mt-3">Update Data Kamar</p>
                ...
                <form action="/kamar/{{ $kamar->id }}" method="POST">
                        ...
                        <div class="form-floating">
                            ...
                            <select class="form-select ml-3 mt-3" id="hotel_id" name="hotel_id"
                                ...
                                @foreach ($hotels as $hotel)
                                    @if (old('hotel_id', $kamar->hotel_id) == $hotel->id)
                    ...
                    <div class="input-group mb-3 justify-content-center">
                        ...
                        <input type="text" name="nomor" value="{{ $kamar->nomor }}" class="form-control col-md-6"
